  ...
  return (
    <div className="flex items-center justify-center gap-3 sm:gap-4">
      <button
        ...
        className={`grid h-14 w-14 place-items-center rounded-full backdrop-blur-md transition-transform duration-200 ease-out hover:scale-[1.015] active:scale-[0.98] sm:h-[3.75rem] sm:w-[3.75rem] ${
          skipActive
        ...
        aria-label="Skip"
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round">
        ...
        <button
          ...
          style={{
            ...
            boxShadow: trailerActive
              ? "0 0 0 1px rgba(216,90,48,0.72) inset, 0 12px 32px rgba(0,0,0,0.38)"
          ...
          onMouseEnter={(e) => {
            if (!trailerActive)
              (e.currentTarget as HTMLButtonElement).style.boxShadow =
                "0 0 0 1px rgba(216,90,48,0.45) inset, 0 12px 32px rgba(0,0,0,0.36)";
          }}
          onMouseLeave={(e) => {
            if (!trailerActive)
              (e.currentTarget as HTMLButtonElement).style.boxShadow =
          ...
          className={`flex h-12 items-center gap-2 rounded-full px-4 backdrop-blur-md transition-transform duration-200 ease-out hover:scale-[1.015] active:scale-[0.98] sm:px-5 ${
            trailerActive ? "bg-[var(--color-cindr)]/18" : "bg-white/[0.045]"
          }`}
          aria-label="Watch trailer"
        >
          <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-[var(--color-cindr)]/20">
            <svg width="10" height="10" viewBox="0 0 9 10" fill="currentColor" className="translate-x-[1px] text-[var(--color-cindr)]">
      ...
      <button
        ...
        style={{
          ...
          boxShadow: likeActive
            ? "0 18px 48px rgba(216,90,48,0.18), 0 18px 50px rgba(0,0,0,0.42)"
            : "0 18px 50px rgba(0,0,0,0.42)",
        }}
        className="grid h-16 w-16 place-items-center rounded-full border border-[var(--color-cindr)]/45 bg-[var(--color-cindr)] text-white transition-transform duration-200 ease-out hover:scale-[1.015] active:scale-[0.98] sm:h-[4.25rem] sm:w-[4.25rem]"
